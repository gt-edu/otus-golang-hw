...
func TestInValidator_ValidateValue(t *testing.T) {
	...
	tests := []struct {
		...
		{v: CustomInt(-1), errMsg: ""},
		{v: CustomInt(0), errMsg: ""},
		{v: CustomInt(1), errMsg: ""},
		{v: CustomInt(3), errMsg: ""},
		{v: CustomInt(-4), errMsg: "input value '-4' is not in the '-1,0,1,2,3' set"},
		{v: CustomString("-1"), errMsg: ""},
		{v: CustomString("0"), errMsg: ""},
		{v: CustomString("1"), errMsg: ""},
		{v: CustomString("3"), errMsg: ""},
		{v: CustomString("-4.1"), errMsg: "input value '-4.1' is not in the '-1,0,1,2,3' set"},
		{v: "-1", errMsg: ""},
		{v: "0", errMsg: ""},
		{v: "1", errMsg: ""},
		{v: "3", errMsg: ""},
